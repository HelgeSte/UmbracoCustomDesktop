...
import { P as ht } from "./pokemonService-DH26ijx6.js";
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const M = globalThis, I = M.ShadowRoot && (M.ShadyCSS === void 0 || M.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, et = Symbol(), V = /* @__PURE__ */ new WeakMap();
let lt = class {
  constructor(t, e, s) {
...
const ct = (r) => new lt(typeof r == "string" ? r : r + "", void 0, et), dt = (r, t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: pt, defineProperty: ut, getOwnPropertyDescriptor: $t, getOwnPropertyNames: _t, getOwnPropertySymbols: ft, getPrototypeOf: mt } = Object, R = globalThis, K = R.trustedTypes, At = K ? K.emptyScript : "", yt = R.reactiveElementPolyfillSupport, S = (r, t) => r, T = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? At : null;
      break;
  ...
  return e;
} }, L = (r, t) => !pt(r, t), Z = { attribute: !0, type: String, converter: T, reflect: !1, useDefault: !1, hasChanged: L };
...
y.elementStyles = [], y.shadowRootOptions = { mode: "open" }, y[S("elementProperties")] = /* @__PURE__ */ new Map(), y[S("finalized")] = /* @__PURE__ */ new Map(), yt?.({ ReactiveElement: y }), (R.reactiveElementVersions ??= []).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const gt = { attribute: !0, type: String, converter: T, reflect: !1, hasChanged: L }, vt = (r = gt, t, e) => {
...
function Et(r) {
  return (t, e) => typeof e == "object" ? vt(r, t, e) : ((s, i, n) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const B = globalThis, N = B.trustedTypes, F = N ? N.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, st = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, it = "?" + _, bt = `<${it}>`, A = document, P = () => A.createComment(""), w = (r) => r === null || typeof r != "object" && typeof r != "function", q = Array.isArray, St = (r) => q(r) || typeof r?.[Symbol.iterator] == "function", D = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, G = /-->/g, Q = />/g, f = RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), X = /'/g, Y = /"/g, rt = /^(?:script|style|textarea|title)$/i, Pt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), b = Pt(1), g = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), tt = /* @__PURE__ */ new WeakMap(), m = A.createTreeWalker(A, 129);
function nt(r, t) {
...
const wt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    n += o === E ? h + bt : l >= 0 ? (s.push(c), h.slice(0, l) + st + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
    ...
    for (; (i = m.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(st)) {
          ...
          h.push({ type: 1, index: n, name: U[2], strings: $, ctor: U[1] === "." ? xt : U[1] === "?" ? Ot : U[1] === "@" ? Ut : k }), i.removeAttribute(l);
...
class Ct {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (o === h.index) {
        let c;
        h.type === 2 ? c = new O(n, n.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(n, h.name, h.strings, this, t) : h.type === 6 && (c = new Mt(n, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class O {
  ...
  _$AI(t, e = this) {
    t = v(this, t, e), w(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== g && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : St(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
Ht?.(C, O), (B.litHtmlVersions ??= []).push("3.3.1");
const Tt = (r, t, e) => {
...
H._$litElement$ = !0, H.finalized = !0, W.litElementHydrateSupport?.({ LitElement: H });
const Nt = W.litElementPolyfillSupport;
Nt?.({ LitElement: H });
(W.litElementVersions ??= []).push("4.2.1");
var Rt = Object.defineProperty, kt = Object.getOwnPropertyDescriptor, j = (r, t, e, s) => {
  for (var i = s > 1 ? void 0 : s ? kt(t, e) : t, n = r.length - 1, o; n >= 0; n--)
    (o = r[n]) && (i = (s ? o(t, e, i) : o(i)) || i);
  return s && i && Rt(t, e, i), i;
};
const jt = "pokedex-menu-items";
let x = class extends ot {
  // Track any errors
  constructor() {
    super(), this._items = [], this._loading = !0, this._error = null, this.fetchPokemon();
  }
  // Fetch tree items
  async fetchPokemon() {
    try {
      this._loading = !0, this._items = await ht.GetPokemon();
    } catch {
  ...
  render() {
    return this._loading ? b`<uui-loader></uui-loader>` : this._error ? b`<uui-menu-item active disabled label="Could not load pokemon!">
        </uui-menu-item>` : b`${this.renderItems(this._items)}`;
  }
};
j([
  z()
...
//# sourceMappingURL=menu-items-CLta1-wU.js.map
